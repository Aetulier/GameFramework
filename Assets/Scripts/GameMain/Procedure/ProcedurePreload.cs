...
namespace GameMain
{
    public class ProcedurePreload : ProcedureBase
    {
        ...
        private void PreloadResources()
        {
            ...
            // Preload fonts
            LoadFont("NotoSansSC-Medium_SDF_W");
        ...
        private void LoadFont(string fontName)
        {
            ...
            GameEntry.Resource.LoadAsset(AssetUtility.GetTMPFontAsset(fontName),typeof(TMP_FontAsset),new GameFramework.Resource.LoadAssetCallbacks((tempAssetName, asset, duration, userdata) => {
