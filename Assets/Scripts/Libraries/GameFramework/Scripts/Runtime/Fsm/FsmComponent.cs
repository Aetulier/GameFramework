...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed class FsmComponent : GameFrameworkComponent
    {
        ...
        public IFsm<T> CreateFsm<T>(T owner, object userData, params FsmState<T>[] states) where T : class
        {
            return m_FsmManager.CreateFsm(owner, userData, states);
        }
        ...
        /// <param name="states">有限状态机状态集合。</param>
        /// <returns>要创建的有限状态机。</returns>
        public IFsm<T> CreateFsm<T>(string name, T owner, object userData, params FsmState<T>[] states) where T : class
        {
            return m_FsmManager.CreateFsm(name, owner, userData, states);
        }
        ...
        /// <param name="states">有限状态机状态集合。</param>
        /// <returns>要创建的有限状态机。</returns>
        public IFsm<T> CreateFsm<T>(T owner, object userData, List<FsmState<T>> states) where T : class
        {
            return m_FsmManager.CreateFsm(owner, userData, states);
        }
        ...
        /// <param name="states">有限状态机状态集合。</param>
        /// <returns>要创建的有限状态机。</returns>
        public IFsm<T> CreateFsm<T>(string name, T owner, object userData, List<FsmState<T>> states) where T : class
        {
            return m_FsmManager.CreateFsm(name, owner, userData, states);
        }
