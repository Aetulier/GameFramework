...
namespace UnityGameFramework.Runtime
{
    ...
    public class DefaultSoundAgentHelper : SoundAgentHelperBase
    {
        ...
        private Transform m_BindingTransform = null;
        ...
        public override void SetBindingTrans(Transform bindingTrans)
        {
            m_BindingTransform = bindingTrans;
        ...
        private void UpdateTransPosition()
        {
            m_CachedTransform.position = m_BindingTransform.position;
        }
