...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        {
            return m_SoundManager.PlaySound(soundAssetName, soundGroupName, priority, playSoundParams, PlaySoundInfo.Create(bindingEntity, null, Vector3.zero, userData));
        }

        public int PlaySound_T(string soundAssetName, string soundGroupName, int priority, PlaySoundParams playSoundParams, Transform trans)
        {
            return PlaySound_T(soundAssetName, soundGroupName, priority, playSoundParams, trans, null);
        }

        public int PlaySound_T(string soundAssetName, string soundGroupName, int priority, PlaySoundParams playSoundParams, Transform trans, object userData)
        {
            return m_SoundManager.PlaySound(soundAssetName, soundGroupName, priority, playSoundParams, PlaySoundInfo.Create(null, trans, Vector3.zero, userData));
        }
        ...
        {
            return m_SoundManager.PlaySound(soundAssetName, soundGroupName, priority, playSoundParams, PlaySoundInfo.Create(null, null, worldPosition, userData));
        }
        ...
        private void OnPlaySoundSuccess(object sender, GameFramework.Sound.PlaySoundSuccessEventArgs e)
        {
            ...
            if (playSoundInfo != null)
            {
                ...
                else if(playSoundInfo.BindingTrans != null)
                {
                    soundAgentHelper.SetBindingTrans(playSoundInfo.BindingTrans);
                }
                else
                {
