...
namespace UnityGameFramework.Runtime
{
    ...
    public sealed partial class UIComponent : GameFrameworkComponent
    {
        ...
        private void Start()
        {
            ...
            CustomizeComponent customCom = GameEntry.GetComponent<CustomizeComponent>();
            if (customCom == null)
            {
                Log.Fatal("Customize component is invalid.");
                return;
            }
            ...
            uiFormHelper.SetUICamera(customCom.GetCustomizeModule("CameraComponent").GetData());
