...
namespace GameFramework.Fsm
{
    ...
    public interface IFsmManager
    {
        ...
        IFsm<T> CreateFsm<T>(T owner, object userData, params FsmState<T>[] states) where T : class;
        ...
        /// <param name="states">有限状态机状态集合。</param>
        /// <returns>要创建的有限状态机。</returns>
        IFsm<T> CreateFsm<T>(string name, T owner, object userData, params FsmState<T>[] states) where T : class;
        ...
        /// <param name="states">有限状态机状态集合。</param>
        /// <returns>要创建的有限状态机。</returns>
        IFsm<T> CreateFsm<T>(T owner, object userData, List<FsmState<T>> states) where T : class;
        ...
        /// <param name="states">有限状态机状态集合。</param>
        /// <returns>要创建的有限状态机。</returns>
        IFsm<T> CreateFsm<T>(string name, T owner, object userData, List<FsmState<T>> states) where T : class;
